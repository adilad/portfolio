...
const work = [
  ...
  },
  {
    ...
    highlights: [
      ...
      'Enhanced the quality of testing by implementing the test pyramidal model, resulting in early bug detection and prevention.',
      'Additionally, achieved a remarkable 23% increase in the efficiency of deploying binaries within the client validation environment.',
  ...
  },
  {
    ...
    highlights: [
      ...
      'To guarantee optimal performance and reliability, configured, administered, and provided support for the network, storage, operating systems, and load balancers within CapWINs production environment.',
      'Successfully mitigated infrastructure risks by migrating bare-metal production servers to VMware EXSI.',
